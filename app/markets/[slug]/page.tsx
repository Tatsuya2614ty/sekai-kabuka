...
const marketConfig = {
    ...
    // Forex
    usdjpy: { title: "USD/JPY", tradingViewSymbol: "FX_IDC:USDJPY" },
    eurusd: { title: "EUR/USD", tradingViewSymbol: "FX_IDC:EURUSD" },
    gbpusd: { title: "GBP/USD", tradingViewSymbol: "FX_IDC:GBPUSD" },
    usdcad: { title: "USD/CAD", tradingViewSymbol: "FX_IDC:USDCAD" },
    audusd: { title: "AUD/USD", tradingViewSymbol: "FX_IDC:AUDUSD" },
    nzdusd: { title: "NZD/USD", tradingViewSymbol: "FX_IDC:NZDUSD" },
    usdchf: { title: "USD/CHF", tradingViewSymbol: "FX_IDC:USDCHF" },
    usdtry: { title: "USD/TRY", tradingViewSymbol: "FX_IDC:USDTRY" },
    usdkrw: { title: "USD/KRW", tradingViewSymbol: "FX_IDC:USDKRW" },
    usdcny: { title: "USD/CNY", tradingViewSymbol: "FX_IDC:USDCNY" },
    usdhkd: { title: "USD/HKD", tradingViewSymbol: "FX_IDC:USDHKD" },
    usdtwd: { title: "USD/TWD", tradingViewSymbol: "FX_IDC:USDTWD" },
    usdsgd: { title: "USD/SGD", tradingViewSymbol: "FX_IDC:USDSGD" },
    usdthb: { title: "USD/THB", tradingViewSymbol: "FX_IDC:USDTHB" },
    usdmyr: { title: "USD/MYR", tradingViewSymbol: "FX_IDC:USDMYR" },
    usdphp: { title: "USD/PHP", tradingViewSymbol: "FX_IDC:USDPHP" },
    usdmxn: { title: "USD/MXN", tradingViewSymbol: "FX_IDC:USDMXN" },
    usdars: { title: "USD/ARS", tradingViewSymbol: "FX_IDC:USDARS" },
    usdbrl: { title: "USD/BRL", tradingViewSymbol: "FX_IDC:USDBRL" },
    usdrub: { title: "USD/RUB", tradingViewSymbol: "FX_IDC:USDRUB" },
    usdinr: { title: "USD/INR", tradingViewSymbol: "FX_IDC:USDINR" },
    usdidr: { title: "USD/IDR", tradingViewSymbol: "FX_IDC:USDIDR" },
    usdvnd: { title: "USD/VND", tradingViewSymbol: "FX_IDC:USDVND" },
    usdzar: { title: "USD/ZAR", tradingViewSymbol: "FX_IDC:USDZAR" },
    usdpln: { title: "USD/PLN", tradingViewSymbol: "FX_IDC:USDPLN" },
    usdsek: { title: "USD/SEK", tradingViewSymbol: "FX_IDC:USDSEK" },
    usdnok: { title: "USD/NOK", tradingViewSymbol: "FX_IDC:USDNOK" },
    usddkk: { title: "USD/DKK", tradingViewSymbol: "FX_IDC:USDDKK" },
    usdczk: { title: "USD/CZK", tradingViewSymbol: "FX_IDC:USDCZK" },
    usdhuf: { title: "USD/HUF", tradingViewSymbol: "FX_IDC:USDHUF" },
